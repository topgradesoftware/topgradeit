#!/usr/bin/env python3
"""
Footer Alignment Update Script
...
def update_footer_alignment(file_path):
    ...
    try:
        ...
        # Pattern to find LinearLayout containing footer content
        # Look for LinearLayout with horizontal orientation and padding
        footer_pattern = r'<LinearLayout\s+[^>]*android:orientation="horizontal"[^>]*android:padding="8dp"[^>]*>'
        
        # Find all potential footer LinearLayouts
        matches = re.finditer(footer_pattern, content, re.DOTALL)
        ...
        for match in matches:
            ...
            if open_count == 0:
                ...
                if ('topgrade_logo' in linear_layout_content or 
                    ...
                    # Add gravity if it doesn't exist
                    if 'android:gravity=' not in linear_layout_content:
                        linear_layout_content = linear_layout_content.replace(
                    ...
                    # Add layout_gravity to ImageView if it doesn't exist
                    ...
                    # Update existing TextView gravity
                    linear_layout_content = re.sub(
                        r'android:gravity="[^"]*"',
                        'android:gravity="center_vertical"',
                        linear_layout_content
                    ...
                    # Add layout_gravity to TextView if it doesn't exist
                    if 'android:layout_gravity=' not in linear_layout_content:
                        linear_layout_content = re.sub(
                            r'(<TextView[^>]*android:text="@string/powered_by_topgrade_software"[^>]*>)',
                            r'\1\n        android:layout_gravity="center_vertical"',
...
def main():
    ...
    print("Footer Alignment Update Script")
    print("=" * 40)
