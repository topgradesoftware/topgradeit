...
public final class CropImage {
  ...
  /**
   * Start pick image activity using modern ActivityResultLauncher (recommended for Android 11+).
   * Uses chooser intent that will have all the available applications for the device like camera 
   * (MyCamera), gallery (Photos), store apps (Dropbox), etc.<br>
   ...
   * @param launcher Modern ActivityResultLauncher to handle the result
   */
  public static void startPickImageActivity(@NonNull Activity activity, @NonNull ActivityResultLauncher<Intent> launcher) {
    launcher.launch(getPickImageChooserIntent(activity));
  }

  /**
   * @deprecated Use {@link #startPickImageActivity(Activity, ActivityResultLauncher)} with modern ActivityResultLauncher instead.
   * This method uses deprecated startActivityForResult and will be removed in a future version.
   */
  @Deprecated
  ...
  public static List<Intent> getGalleryIntents(
    ...
    if (Intent.ACTION_GET_CONTENT.equals(action)) {
      ...
      galleryIntent = new Intent(action, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    ...
    if (!includeDocuments) {
      for (Intent intent : intents) {
        if (intent.getComponent() != null && 
            "com.android.documentsui.DocumentsActivity".equals(intent
            .getComponent()
            .getClassName())) {
  ...
  public static boolean hasPermissionInManifest(
    ...
    try {
      ...
      // Package not found, return false
    }
    return false;
  }
   ...
   * Result will be received in the activity result callback and can be
   ...
   * #activity(Uri)}.
   *
   * @param data result data intent as received in the activity result callback.
  ...
  public static ActivityResult getActivityResult(@Nullable Intent data) {
    ...
    // Use API 33+ method if available, otherwise fallback to legacy method
    if (Build.VERSION.SDK_INT >= 33) {
      return data.getParcelableExtra(CROP_IMAGE_EXTRA_RESULT, ActivityResult.class);
    } else {
      // Legacy method for API < 33
      return data.getParcelableExtra(CROP_IMAGE_EXTRA_RESULT);
    }
  }
  ...
  public static final class ActivityBuilder {
    ...
    public Intent getIntent(@NonNull Context context, @Nullable Class<?> cls) {
      ...
      intent.setClass(context, cls != null ? cls : CropImageActivity.class);
     ...
     * @deprecated Use modern ActivityResultLauncher instead
     */
    @Deprecated
     ...
     * See: <a href="http://developer.android.com/design/style/metrics-grids.html#48dp-rhythm">48dp Rhythm</a><br>
     * <i>Default: 48dp</i>
     */
    ...
    public ActivityBuilder setShowCropOverlay(boolean showCropOverlay) {
      mOptions.isShowCropOverlay = showCropOverlay;
      return this;
    }
    ...
    public ActivityBuilder setAutoZoomEnabled(boolean autoZoomEnabled) {
      mOptions.isAutoZoomEnabled = autoZoomEnabled;
      return this;
    }
    ...
    public ActivityBuilder setMultiTouchEnabled(boolean multiTouchEnabled) {
      mOptions.isMultiTouchEnabled = multiTouchEnabled;
      return this;
    }
    ...
    public ActivityBuilder setFixAspectRatio(boolean fixAspectRatio) {
      mOptions.isFixAspectRatio = fixAspectRatio;
      return this;
    }
    ...
    public ActivityBuilder setAspectRatio(int aspectRatioX, int aspectRatioY) {
      ...
      mOptions.isFixAspectRatio = true;
      return this;
    }
    ...
    public ActivityBuilder setNoOutputImage(boolean noOutputImage) {
      mOptions.isNoOutputImage = noOutputImage;
      return this;
    }
    ...
    public ActivityBuilder setAllowRotation(boolean allowRotation) {
      mOptions.isAllowRotation = allowRotation;
      return this;
    }
    ...
    public ActivityBuilder setAllowFlipping(boolean allowFlipping) {
      mOptions.isAllowFlipping = allowFlipping;
      return this;
    }
    ...
    public ActivityBuilder setAllowCounterRotation(boolean allowCounterRotation) {
      mOptions.isAllowCounterRotation = allowCounterRotation;
      return this;
    }
    ...
    public ActivityBuilder setFlipHorizontally(boolean flipHorizontally) {
      mOptions.isFlipHorizontally = flipHorizontally;
      return this;
    }
    ...
    public ActivityBuilder setFlipVertically(boolean flipVertically) {
      mOptions.isFlipVertically = flipVertically;
      return this;
    }
