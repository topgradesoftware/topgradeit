package topgrade.parent.com.parentseeks.Teacher.ViewModel
...
class StaffLoginViewModel(private val userRepository: ConsolidatedUserRepository) : ViewModel() {
    ...
    fun login(email: String, password: String, campusId: String, fcmToken: String, userType: String) {
        ...
        viewModelScope.launch {
            val result = userRepository.staffLogin(email, password, campusId, fcmToken, userType)
