...
public class HomeAdaptor extends RecyclerView.Adapter<HomeAdaptor.Holder> {
    View v;
    List<HomeModel> list;
    OnMenuCLick onClickListener;
    int cardBackgroundColor;

    public HomeAdaptor(List<HomeModel> list, OnMenuCLick onClickListener) {
        this.list = list;
        this.onClickListener = onClickListener;
        this.cardBackgroundColor = R.color.dark_brown; // Default parent color
    }

    public HomeAdaptor(List<HomeModel> list, OnMenuCLick onClickListener, int cardBackgroundColor) {
        this.list = list;
        this.onClickListener = onClickListener;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.home_item, viewGroup, false);
        return new Holder(v);
    }
