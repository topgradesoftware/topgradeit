...
import topgrade.parent.com.parentseeks.Parent.Adaptor.ParentComplaintAdapter;
import topgrade.parent.com.parentseeks.Parent.Model.ParentComplaintModel;
import topgrade.parent.com.parentseeks.Teacher.Utils.Constant;

public class ParentComplaintList extends AppCompatActivity {

    private static final String TAG = "ParentComplaintList";

    RecyclerView complaintRcv;
    ProgressBar progressBar;
    Context context;
    List<ParentComplaintModel.Complaint> list = new ArrayList<>();
    TextView totalRecords;
    TextView headerTitle;
    ParentComplaintAdapter adapter;
    View emptyView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_complaint_list);
        ...
        context = ParentComplaintList.this;
        Paper.init(context);
    ...
    private void initViews() {
        ...
        swipeRefresh.setColorSchemeResources(R.color.dark_brown);
    }
    ...
    private void loadComplaints() {
        try {
            ...
            if (parentId.isEmpty() || campusId.isEmpty()) {
                Log.e(TAG, "Parent ID or Campus ID not found in Paper");
                showEmptyState(true);
                return;
            }
                ...
                public void onResponse(Call<ParentComplaintModel> call, Response<ParentComplaintModel> response) {
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (parentComplaintModel.getData() != null && !parentComplaintModel.getData().isEmpty()) {
                            ...
                            list = parentComplaintModel.getData();
                            updateUI();
    ...
    private List<ParentComplaintModel.Complaint> filterComplaints(List<ParentComplaintModel.Complaint> complaints, String filterType) {
    ...
    private void cacheComplaints(List<ParentComplaintModel.Complaint> complaints) {
        try {
            if (complaints != null && !complaints.isEmpty()) {
                Paper.book().write("parent_complaints_cache", complaints);
    ...
    private List<ParentComplaintModel.Complaint> loadCachedComplaints() {
        try {
            List<ParentComplaintModel.Complaint> cachedComplaints = Paper.book().read("parent_complaints_cache", new ArrayList<>());
    ...
    private void loadInitialCachedComplaints() {
        List<ParentComplaintModel.Complaint> cachedComplaints = loadCachedComplaints();
