...
public class StudentComplaintAdapter extends RecyclerView.Adapter<StudentComplaintAdapter.ViewHolder> {

    private List<StudentComplaintModel.Complaint> complaints;
    ...
    public StudentComplaintAdapter(List<StudentComplaintModel.Complaint> complaints, Context context, String filterType) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.student_complaint_item_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        StudentComplaintModel.Complaint complaint = complaints.get(position);
    ...
    private void showComplaintMenu(View view, StudentComplaintModel.Complaint complaint, int position) {
    ...
    public void updateData(List<StudentComplaintModel.Complaint> newComplaints) {
